        ...
        try{
            ...
            if(cek_max_reg){
                ...
                const insert_detail_7_soal71 = await new Promise((resolve, reject) => {
                    Connection.query("INSERT INTO kb_detail_7 SET ?", [{id: null, kode_registrasi: newId, jawaban: essaybox_7_1, date_created: tanggal, date_updated: null, time_created: waktu, time_updated: null}], (error) => {
                        if(error){
                            reject(error)
                        } else {
                            resolve("true")
                ...
                const insert_detail_7_soal72 = await new Promise((resolve, reject) => {
                    Connection.query("INSERT INTO kb_detail_7 SET ?", [{id: null, kode_registrasi: newId, jawaban: essaybox_7_2, date_created: tanggal, date_updated: null, time_created: waktu, time_updated: null}], (error) => {
                        if(error){
                            reject(error)
                        } else {
                            resolve("true")
                ...
                const insert_detail_7_soal73 = await new Promise((resolve, reject) => {
                    Connection.query("INSERT INTO kb_detail_7 SET ?", [{id: null, kode_registrasi: newId, jawaban: essaybox_7_3, date_created: tanggal, date_updated: null, time_created: waktu, time_updated: null}], (error) => {
                        if(error){
                            reject(error)
                        } else {
                            resolve("true")
